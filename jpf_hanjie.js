...
// Run the init() function and the page loads
window.onload = init;
...
function setupPuzzle() {
  ...
  document.getElementById("hanjieGrid").addEventListener("mouseup",
   function() {
      ...
      if(solved) alert("Congrats! You've solved the Puzzle");
      });

  // Create object collections (array) of the filled and empty cells
